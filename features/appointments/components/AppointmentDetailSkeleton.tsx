  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 pb-12 animate-pulse-soft">
      ...
      <div className="card p-6 bg-surface mb-6">
        ...
        {/* Description */}
        <div className="mb-6 p-4 rounded-xl bg-surface border border-default space-y-2">
      ...
      <div className="card p-6 bg-surface">
        ...
        <div className="space-y-3">
          {[1, 2].map((i) => (
            <div
              key={i}
              className="flex items-center justify-between p-3 rounded-lg bg-surface border border-default"
            >
