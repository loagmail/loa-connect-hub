  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-2">
        <h2 className="text-base sm:text-lg font-bold text-primary">{variant === "meetings" ? "Upcoming Meetings" : "Upcoming Consultations"}</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div>
            {selectedDate ? (
              ...
              <div className="card p-8 text-center bg-surface h-full flex flex-col items-center justify-center">
                <div className="w-10 h-10 bg-surface border border-default rounded-xl flex items-center justify-center mb-3 text-tertiary">
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  </svg>
                </div>
                <p className="text-sm font-semibold text-secondary">Select a day</p>
                <p className="text-xs text-tertiary mt-1">Click a date on the calendar to see your consultations.</p>
              </div>
            )}
          </div>
        </div>
