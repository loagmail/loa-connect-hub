    ...
    <div className="max-w-6xl mx-auto space-y-6 sm:space-y-8 pb-12">
      ...
      {isDean && departmentStats && (
        <div className="animate-fade-in" style={{ animationDelay: "0.32s" }}>
          <div className="card p-5 sm:p-6 bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200/60">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-amber-100 border border-amber-200 flex items-center justify-center text-lg shrink-0">
                  🏛️
                </div>
                <div>
                  <p className="text-sm font-bold text-slate-900">Department Pulse</p>
                  <p className="text-xs text-slate-500">{departmentName || "Your Department"}</p>
                </div>
              </div>
              <Link
                href="/admin/reports/health"
                className="inline-flex items-center justify-center gap-1.5 px-4 py-2.5 sm:py-2 rounded-lg bg-white border border-amber-200 text-amber-700 text-xs font-semibold hover:bg-amber-50 hover:border-amber-300 transition-all duration-200 min-h-[44px] sm:min-h-0"
              >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {[
                ...
                <div key={s.label} className="bg-white/70 rounded-lg p-3 border border-amber-100/50">
