    ...
    <div className="max-w-6xl mx-auto space-y-6 sm:space-y-8 pb-12">
      ...
      <div className="card p-5 sm:p-6 bg-white flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-0 sm:justify-between">
        ...
        <Link
          ...
          className="inline-flex items-center justify-center gap-1.5 px-5 py-3 sm:py-2 rounded-lg bg-gold-600 text-white text-sm font-semibold hover:bg-gold-700 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 shadow-sm w-full sm:w-auto"
        >
