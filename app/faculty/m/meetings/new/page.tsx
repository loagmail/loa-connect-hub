  ...
  return (
    <div className="px-4 py-6 max-w-lg mx-auto space-y-6 pb-24">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold text-primary">Schedule a Meeting</h1>
          <p className="text-sm text-tertiary mt-1">Schedule a meeting with a student.</p>
        </div>
        <Link
          href="/faculty/m/meetings"
          className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-surface border border-default text-tertiary hover:bg-surface-hover transition-colors shrink-0"
        >
